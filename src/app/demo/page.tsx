...
export default function DemoPage() {
  ...
  const emvData = useMemo(
    ...
    [multiplier, sponsorMod, platform]
  );
  ...
  const engagementData = useMemo(
    () =>
      baseEngagement
        ...
        .map((e) => ({
          sponsor: e.sponsor,
          reach: Math.round(e.reach * multiplier),
          engagement: +(e.engagement * (sponsorMod * 2 + 0.3)).toFixed(1),
        })),
    [multiplier, sponsor, sponsorMod]
  );
        ...
        <Container>
            ...
            <div className="flex w-full flex-col items-start justify-between gap-6 lg:flex-row lg:items-end">
              <div>
                ...
                <p className="mt-4 max-w-xl text-[15px] text-white/60">
                  All figures below are synthetic data for illustration. Filter by
                  sponsor, platform or period — the whole dashboard re-computes in
                  real time.
                </p>
              </div>
          ...
          <div className="mt-6 rounded-2xl border border-white/[0.08] bg-gradient-to-b from-white/[0.03] to-transparent p-5 lg:p-6">
            <div className="flex items-start justify-between">
              ...
              <Badge className="text-[11px]">Synthetic data</Badge>
            </div>
