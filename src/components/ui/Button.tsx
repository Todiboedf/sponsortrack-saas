...
const variants: Record<Variant, string> = {
  ...
  cyan:
    "text-[#0A1628] bg-[#7dd3fc] hover:bg-[#bae6fd] " +
    "shadow-[0_10px_36px_-12px_rgba(125,211,252,0.7),inset_0_1px_0_rgba(255,255,255,0.32)] " +
    "hover:shadow-[0_18px_50px_-10px_rgba(125,211,252,0.9),0_0_40px_-6px_rgba(125,211,252,0.55),inset_0_1px_0_rgba(255,255,255,0.45)]",
};
